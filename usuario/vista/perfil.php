...
<html lang="en">
  <head>
    ...
    <title>ACOMERTIPICO.COM</title>
  </head>
  <body>
    <h1>Si aparece esto es por que si se pudooo!!! Nmms</h1>
    
    <!-- Barra de navegacion del Administrador -->
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="img/logo1.png" width="60" height="60" alt="AcomerTipico.com"></a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="#">Iniciar Pedido</a></li>
            <li><a class="dropdown-item" href="#">Modificar Pedido</a></li>
